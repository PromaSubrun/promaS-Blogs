<?php $__env->startSection('content'); ?>
	...
	<section class="fh5co-top-banner">
		<div class="top-banner__inner site-container">
			<div class="top-banner__image">
				<img src="./images/profile.jpg" alt="author image">
			</div>
			<div class="top-banner__text">
				<div class="top-banner__text-up">
					<span class="brand-span">Hello! I'm</span>
					<h2 class="top-banner__h2">Sadia</h2>
				</div>
				<div class="top-banner__text-down">
					<h2 class="top-banner__h2">Subrun</h2>
					<span class="brand-span">Author, Writer, Traveler, Cook</span>
				</div>
				<p>I am a writer, anything you say or do may be used in a story!</p>
		...
		<div class="about-me-inner site-container">
			<article class="portfolio-wrapper">
				<div class="portfolio__img">
					<img src="./images/AboutSadiaSubrun.jpg" class="about-me__profile" alt="about me profile picture">
				</div>
				<div class="portfolio__bottom">
					<div class="portfolio__name">
						<span>S</span>
						<h2 class="universal-h2">adia Subrun</h2>
					</div>
					<p>Sadia Subrun is a short story author, novelist, and award-winning poet.</p>
				</div>
			</article>
    ...
    <!-- Education-->
     <section class="fh5co-education">
		<div class="site-container">
			<div class="about-me-slider">
				<div>
				    </br></br></br></br></br></br></br></br></br></br>
					<h2 class="universal-h2 universal-h2-bckg">Education</h2>
					</br></br></br></br></br></br></br></br></br></br>
					<img src="./images/quotes.svg">
					<p>B.Sc</p>
					<p>Software Engineering</p>
					<p>Daffodil International University, Dhanmondi</p>
					<img src="./images/quotes.svg">	
					</br></br></br></br></br></br></br></br></br></br>
				</div>
			</div>
		...
		<div class="site-container">
			...
			<div class="books">
				<div class="single-book">
					...
					<span class="single-book__price">$13.00</span>
					<!-- star rating -->
					<div class="rating">
						<span>&#9734;</span>
						<span>&#9734;</span>
				...
				<div class="single-book">
					...
					<span class="single-book__price">$20.00</span>
					<!-- star rating -->
					<div class="rating">
						<span>&#9734;</span>
						<span>&#9734;</span>
			...
			<div class="blog-slider blog-inner">
				<div class="single-blog">
					<div class="single-blog__img">
						<img src="./images/Donut.jpg" alt="blog image">
					</div>
					<div class="single-blog__text">
						<h4>Donut</h4>
						<span>On June 28, 2017</span>
						<p>These rich, moist, whole-wheat doughnuts get a double dose of chocolaty goodness—from cocoa powder in the batter and a finishing drizzle of melted chocolate over the top. The doughnuts themselves are not overly sweet; the chocolate topping balances out the flavors. The doughnuts are best enjoyed the same day they’re baked (not a problem if there are kids in the house). If you have leftovers, try refreshing them in the microwave for about five seconds—long enough to soften the doughnut without completely melting the topping.</p>
					</div>
				</div>
				<div class="single-blog">
					<div class="single-blog__img">
						<img src="./images/Momos.jpg" alt="blog image">
					</div>
					<div class="single-blog__text">
						<h4>Momos</h4>
						<span>On August 28, 2017</span>
						<p>These popular street dumplings stand as the most favourite food for kids today. Momos, originating from Tibet is a hugely popular street food in the country, largely in North-India. A versatile food that it is, we have a wide variety available from chicken, mutton to what we have here, vegetable momos. Since the kids love the dish so much, it is always great to make it at home. You just need to master the technique and you can twist them to suit your palate.</p>
					</div>
				</div>
				<div class="single-blog">
					<div class="single-blog__img">
						<img src="./images/Burger.jpg" alt="blog image">
					</div>
					<div class="single-blog__text">
						<h4>Burger</h4>
						<span>On August 28, 2017</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\PromaS Blogs\resources\views/pages/index.blade.php ENDPATH**/ ?>